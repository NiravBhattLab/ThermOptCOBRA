...
# -*- coding: utf-8 -*-
#
# carveme documentation build configuration file, created by
...
project = u'ThermOptCOBRA'
copyright = u'2024, Pavan (IITM)'
author = u'Pavan and Nirav'
...
htmlhelp_basename = 'thermoptcobradoc'
